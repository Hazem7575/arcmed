import { useSSRContext, mergeProps, resolveComponent, withCtx, createVNode, createTextVNode, toDisplayString, openBlock, createBlock, createCommentVNode, Fragment, renderList, createSSRApp, h } from "vue";
...
const Loading = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["ssrRender", _sfc_ssrRender$7]]);
const _sfc_main$6 = {
  name: "HeaderApp",
  mounted() {
    $$1(".st-munu-toggle").on("click", function() {
      $$1(this).toggleClass("st-toggle-active").siblings(".st-nav-list").slideToggle();
    });
    $$1(".st-munu-dropdown-toggle").on("click", function() {
      $$1(this).toggleClass("active").siblings("ul").slideToggle();
    });
  }
};
function _sfc_ssrRender$6(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`</div><div class="st-main-header-right"><div class="st-nav"><ul class="st-nav-list st-onepage-nav"><li>`);
  _push(ssrRenderComponent(_component_Link, {
    href: _ctx.route("index"),
    class: "st-smooth-move"
  }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`${ssrInterpolate(_ctx.__("Navbar.Home"))}`);
      } else {
        return [
          createTextVNode(toDisplayString(_ctx.__("Navbar.Home")), 1)
        ];
      }
    }),
    _: 1
  ...
  _push(ssrRenderComponent(_component_Link, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`${ssrInterpolate(_ctx.__("Navbar.About"))}`);
      } else {
        return [
          createTextVNode(toDisplayString(_ctx.__("Navbar.About")), 1)
        ];
      }
    }),
    _: 1
  }, _parent));
  _push(`</li><li><a href="#department" class="st-smooth-move">${ssrInterpolate(_ctx.__("Navbar.department"))}</a></li><li><a href="#doctors" class="st-smooth-move">${ssrInterpolate(_ctx.__("Navbar.Doctors"))}</a></li><li><a href="#gallery" class="st-smooth-move">${ssrInterpolate(_ctx.__("Navbar.Gallery"))}</a></li><li><a href="#contact" class="st-smooth-move">${ssrInterpolate(_ctx.__("Navbar.Contact Us"))}</a></li></ul><span class="st-munu-toggle"><span></span></span></div></div></div></div></div></header>`);
}
...
const HeaderApp = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["ssrRender", _sfc_ssrRender$6]]);
const _sfc_main$5 = {
  name: "FooterApp"
};
...
const FooterApp = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["ssrRender", _sfc_ssrRender$5]]);
const _sfc_main$4 = {
  name: "App",
...
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_app, mergeProps({
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="st-content pages-content"${_scopeId}><div class="st-height-b120 st-height-lg-b50"${_scopeId}></div><section class="st-about-wrap" id="about"${_scopeId}><div class="container-fluid p-0"${_scopeId}><div class="row m-0"${_scopeId}><div class="col-lg-6 col-md-12 p-0"${_scopeId}><div class="about-image"${_scopeId}><img${ssrRenderAttr("src", _ctx.asset_url("assets/img/about-img1.jpg"))} alt="image"${_scopeId}></div></div><div class="col-lg-6 col-md-12 p-0"${_scopeId}><div class="about-content"${_scopeId}><span${_scopeId}>معلومات عنا</span><h2${_scopeId}>من نكون نحن ومن اين بدائنا</h2><p${_scopeId}>اكميد هو مركز علاج طبيعي يعالج جميع الالم بطرق طبيعيه نحن نملك فريق طبئ كبير ومميز يمكنك الاعتماد علينا تاسسنا عام 2010 في المملكة العربية السعوديه يتميز بي</p><ul${_scopeId}><li${_scopeId}><i class="fa fa-check"${_scopeId}></i>مستشفي للعلاج الطبيعي للرجال</li><li${_scopeId}><i class="fa fa-check"${_scopeId}></i>مستشفي للعلاج الطبيعي للنساء</li><li${_scopeId}><i class="fa fa-check"${_scopeId}></i>مستشفي للعلاج الطبيعي للاطفال</li><li${_scopeId}><i class="fa fa-check"${_scopeId}></i>علاج جميع انواع الالم بطريقه طبيعيه</li><li${_scopeId}><i class="fa fa-check"${_scopeId}></i>فريق متكامل ومميز لعلاجك</li><li${_scopeId}><i class="fa fa-check"${_scopeId}></i>امتلاك مهارات التخصص المهني في العيادة</li></ul></div></div></div></div></section><div class="st-height-b120 st-height-lg-b50"${_scopeId}></div><div class="container"${_scopeId}><div class="st-section-heading st-style1"${_scopeId}><h2 class="st-section-heading-title font-weight-bold color-web" style="${ssrRenderStyle({ "font-size": "20px" })}"${_scopeId}>نبذه عن من نحن</h2><div class="st-seperator"${_scopeId}><div class="st-seperator-left wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.2s"${_scopeId}></div><div class="st-seperator-center"${_scopeId}><img${ssrRenderAttr("src", _ctx.asset_url("assets/img/icons/4.png"))} alt="icon"${_scopeId}></div><div class="st-seperator-right wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.2s"${_scopeId}></div></div><div class="st-section-heading-subtitle"${_scopeId}><div class="content-body-text"${_scopeId}><h1${_scopeId}>فكرة عامة عن تخصص العلاج الطبيعي وإعادة التأهيل</h1><p${_scopeId}> يعد تخصص العلاج الطبيعي وإعادة التأهيل من التخصصات المهمة؛ إذ يهدف إلى تعزيز الحياة الوظيفية لأعضاء الجسم واستعادة نشاطها الطبيعي حال إصابتها واختلال عملها، بحيث يتخصص أطباء العلاج الطبيعي في استعادة الوظيفة المثلى للعضو في الجهاز العصبي، من خلال ممارسة حركات محددة يقوم المصاب بعملها تحت إشراف الطبيب.</p><div class="st-height-b40 st-height-lg-b40"${_scopeId}></div><h1${_scopeId}>ماهي مميزات دراسة العلاج الطبيعي وإعادة التأهيل؟</h1><p${_scopeId}> يمتاز تخصص العلاج الطبيعي وإعادة التأهيل بأنه أحد أهم التخصصات في الجامعات العالمية، كما أن التخصص مطلوب في كل مستشفيات العالم، العامة والخاصة، مما يتيح للخريجين فرص عمل هائلة، وكذلك إمكانية الممارسة العملية والاختلاط بالحياة العملية الحقيقة، في أكثر من مجال، مثل النوادي الرياضية وتدريب الألعاب الرياضية المختلفة، والعلاج الوظيفي في الشركات، والعيادات الخاصة للعلاج الطبيعي والتأهيل البدني، والمدارس ورياض الأطفال، ورعاية الطلاب البدنية.</p></div></div></div><div class="st-height-b40 st-height-lg-b40"${_scopeId}></div></div><div class="st-height-b120 st-height-lg-b50"${_scopeId}></div><div class="container"${_scopeId}><div class="st-section-heading st-style1"${_scopeId}><h2 class="st-section-heading-title font-weight-bold color-web" style="${ssrRenderStyle({ "font-size": "20px" })}"${_scopeId}>شركئنا</h2><div class="st-seperator"${_scopeId}><div class="st-seperator-left wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.2s"${_scopeId}></div><div class="st-seperator-center"${_scopeId}><img${ssrRenderAttr("src", _ctx.asset_url("assets/img/icons/4.png"))} alt="icon"${_scopeId}></div><div class="st-seperator-right wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.2s"${_scopeId}></div></div><div class="st-section-heading-subtitle"${_scopeId}>`);
            ...
            if (_push3) {
              _push3(ssrRenderComponent(_component_swiper_slide, null, {
                default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(`<div class="partner-item"${_scopeId3}><a href="#"${_scopeId3}><img${ssrRenderAttr("src", _ctx.asset_url("assets/img/partner/1.png"))} alt="image"${_scopeId3}></a></div>`);
                  } else {
                    return [
                      createVNode("div", { class: "partner-item" }, [
                        createVNode("a", { href: "#" }, [
                          createVNode("img", {
                            src: _ctx.asset_url("assets/img/partner/1.png"),
                            alt: "image"
                          }, null, 8, ["src"])
                        ])
                      ])
              ...
              _push3(ssrRenderComponent(_component_swiper_slide, null, {
                default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(`<div class="partner-item"${_scopeId3}><a href="#"${_scopeId3}><img${ssrRenderAttr("src", _ctx.asset_url("assets/img/partner/2.png"))} alt="image"${_scopeId3}></a></div>`);
                  } else {
                    return [
                      createVNode("div", { class: "partner-item" }, [
                        createVNode("a", { href: "#" }, [
                          createVNode("img", {
                            src: _ctx.asset_url("assets/img/partner/2.png"),
                            alt: "image"
                          }, null, 8, ["src"])
                        ])
                      ])
              ...
              _push3(ssrRenderComponent(_component_swiper_slide, null, {
                default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(`<div class="partner-item"${_scopeId3}><a href="#"${_scopeId3}><img${ssrRenderAttr("src", _ctx.asset_url("assets/img/partner/3.png"))} alt="image"${_scopeId3}></a></div>`);
                  } else {
                    return [
                      createVNode("div", { class: "partner-item" }, [
                        createVNode("a", { href: "#" }, [
                          createVNode("img", {
                            src: _ctx.asset_url("assets/img/partner/3.png"),
                            alt: "image"
                          }, null, 8, ["src"])
                        ])
                      ])
        ...
        _push2(`</div></div><div class="st-height-b40 st-height-lg-b40"${_scopeId}></div></div></div>`);
      } else {
        return [
          createVNode("div", { class: "st-content pages-content" }, [
            ...
            createVNode("section", {
              ...
              createVNode("div", { class: "container-fluid p-0" }, [
                createVNode("div", { class: "row m-0" }, [
                  createVNode("div", { class: "col-lg-6 col-md-12 p-0" }, [
                    createVNode("div", { class: "about-image" }, [
                      createVNode("img", {
                        src: _ctx.asset_url("assets/img/about-img1.jpg"),
                        alt: "image"
                      }, null, 8, ["src"])
                    ])
                  ]),
                  createVNode("div", { class: "col-lg-6 col-md-12 p-0" }, [
                    createVNode("div", { class: "about-content" }, [
                      createVNode("span", null, "معلومات عنا"),
                      createVNode("h2", null, "من نكون نحن ومن اين بدائنا"),
                      createVNode("p", null, "اكميد هو مركز علاج طبيعي يعالج جميع الالم بطرق طبيعيه نحن نملك فريق طبئ كبير ومميز يمكنك الاعتماد علينا تاسسنا عام 2010 في المملكة العربية السعوديه يتميز بي"),
                      createVNode("ul", null, [
                        createVNode("li", null, [
                          createVNode("i", { class: "fa fa-check" }),
                          createTextVNode("مستشفي للعلاج الطبيعي للرجال")
                        ]),
                        createVNode("li", null, [
                          createVNode("i", { class: "fa fa-check" }),
                          createTextVNode("مستشفي للعلاج الطبيعي للنساء")
                        ]),
                        createVNode("li", null, [
                          createVNode("i", { class: "fa fa-check" }),
                          createTextVNode("مستشفي للعلاج الطبيعي للاطفال")
                        ]),
                        createVNode("li", null, [
                          createVNode("i", { class: "fa fa-check" }),
                          createTextVNode("علاج جميع انواع الالم بطريقه طبيعيه")
                        ]),
                        createVNode("li", null, [
                          createVNode("i", { class: "fa fa-check" }),
                          createTextVNode("فريق متكامل ومميز لعلاجك")
                        ]),
                        createVNode("li", null, [
                          createVNode("i", { class: "fa fa-check" }),
                          createTextVNode("امتلاك مهارات التخصص المهني في العيادة")
                        ])
                      ])
                    ])
                  ])
            ...
            createVNode("div", { class: "container" }, [
              createVNode("div", { class: "st-section-heading st-style1" }, [
                createVNode("h2", {
                  class: "st-section-heading-title font-weight-bold color-web",
                ...
                createVNode("div", { class: "st-seperator" }, [
                  ...
                  createVNode("div", { class: "st-seperator-center" }, [
                    createVNode("img", {
                      src: _ctx.asset_url("assets/img/icons/4.png"),
                      alt: "icon"
                    }, null, 8, ["src"])
                  ]),
                  createVNode("div", {
                ...
                createVNode("div", { class: "st-section-heading-subtitle" }, [
                  createVNode("div", { class: "content-body-text" }, [
                    createVNode("h1", null, "فكرة عامة عن تخصص العلاج الطبيعي وإعادة التأهيل"),
                    createVNode("p", null, " يعد تخصص العلاج الطبيعي وإعادة التأهيل من التخصصات المهمة؛ إذ يهدف إلى تعزيز الحياة الوظيفية لأعضاء الجسم واستعادة نشاطها الطبيعي حال إصابتها واختلال عملها، بحيث يتخصص أطباء العلاج الطبيعي في استعادة الوظيفة المثلى للعضو في الجهاز العصبي، من خلال ممارسة حركات محددة يقوم المصاب بعملها تحت إشراف الطبيب."),
                    createVNode("div", { class: "st-height-b40 st-height-lg-b40" }),
                    createVNode("h1", null, "ماهي مميزات دراسة العلاج الطبيعي وإعادة التأهيل؟"),
                    createVNode("p", null, " يمتاز تخصص العلاج الطبيعي وإعادة التأهيل بأنه أحد أهم التخصصات في الجامعات العالمية، كما أن التخصص مطلوب في كل مستشفيات العالم، العامة والخاصة، مما يتيح للخريجين فرص عمل هائلة، وكذلك إمكانية الممارسة العملية والاختلاط بالحياة العملية الحقيقة، في أكثر من مجال، مثل النوادي الرياضية وتدريب الألعاب الرياضية المختلفة، والعلاج الوظيفي في الشركات، والعيادات الخاصة للعلاج الطبيعي والتأهيل البدني، والمدارس ورياض الأطفال، ورعاية الطلاب البدنية.")
                  ])
                ])
              ]),
              createVNode("div", { class: "st-height-b40 st-height-lg-b40" })
              ...
              createVNode("div", { class: "st-section-heading st-style1" }, [
                ...
                createVNode("div", { class: "st-section-heading-subtitle" }, [
                  createVNode(_component_swiper, {
                    ...
                    _: 1
                  }, 8, ["onSwiper", "onSlideChange", "breakpoints", "modules"])
                ])
              ]),
              createVNode("div", { class: "st-height-b40 st-height-lg-b40" })
            ])
...
const Welcome_vue_vue_type_style_index_0_scoped_64c352fa_lang = "";
const _sfc_main = {
  name: "Welcome",
  ...
  mounted() {
    ...
    $$1(".st-before-after").each(function() {
      var $container = $$1(this), $before = $container.find(".st-before");
      $container.find(".st-after");
      var $handle = $container.find(".st-handle-before-after");
      var maxX = $container.outerWidth(), offsetX = $container.offset().left;
      var touchstart, touchmove, touchend;
      var mousemove = function(e) {
        e.preventDefault();
        var curX = e.clientX - offsetX, curPos = curX / maxX * 100;
        if (curPos > 100) {
          curPos = 100;
        }
        if (curPos < 0) {
      ...
      var mouseup = function(e) {
        e.preventDefault();
        if (supportsTouch) {
          $$1(document).off("touchmove", touchmove);
          $$1(document).off("touchend", touchend);
        } else {
          $$1(document).off("mousemove", mousemove);
          $$1(document).off("mouseup", mouseup);
        }
      };
      var mousedown = function(e) {
        ...
        e.clientX - offsetX;
        if (supportsTouch) {
          $$1(document).on("touchmove", touchmove);
          $$1(document).on("touchend", touchend);
        } else {
          $$1(document).on("mousemove", mousemove);
          $$1(document).on("mouseup", mouseup);
        }
      };
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_app, mergeProps({
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="st-content" data-v-64c352fa${_scopeId}>`);
        _push2(ssrRenderComponent(_component_slider, { sliders: $props.sliders }, null, _parent2, _scopeId));
        _push2(`<section data-v-64c352fa${_scopeId}><div class="st-height-b120 st-height-lg-b80" data-v-64c352fa${_scopeId}></div><div class="container" data-v-64c352fa${_scopeId}><div class="row" data-v-64c352fa${_scopeId}><div class="col-lg-4" data-v-64c352fa${_scopeId}><div class="st-iconbox st-style1" data-v-64c352fa${_scopeId}><div class="st-iconbox-icon st-purple-box" data-v-64c352fa${_scopeId}><svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" xml:space="preserve" data-v-64c352fa${_scopeId}><g data-v-64c352fa${_scopeId}><path d="M482.726,485.783l-22.65-132.603c-2.441-14.287-12.576-25.764-26.453-29.95l-61.092-18.433
                      ...
                      s-23.8-10.676-23.8-23.8c0-13.124,10.677-23.8,23.8-23.8S389.001,385.251,389.001,398.375z" data-v-64c352fa${_scopeId}></path></g></svg></div><h2 class="st-iconbox-title" data-v-64c352fa${_scopeId}>تواصل مع مختصين</h2><div class="st-iconbox-text" data-v-64c352fa${_scopeId}>تواصل مع جميع الاطباء المختصين في العلاج الطبيعي.</div></div><div class="st-height-b0 st-height-lg-b30" data-v-64c352fa${_scopeId}></div></div><div class="col-lg-4" data-v-64c352fa${_scopeId}><div class="st-iconbox st-style1" data-v-64c352fa${_scopeId}><div class="st-iconbox-icon st-green-box" data-v-64c352fa${_scopeId}><svg enable-background="new 0 0 511.988 511.988" viewBox="0 0 511.988 511.988" xmlns="http://www.w3.org/2000/svg" data-v-64c352fa${_scopeId}><g data-v-64c352fa${_scopeId}><path d="m511.988 227.658c0-60.096-23.44-116.593-66.004-159.085-42.559-42.489-99.142-65.888-159.327-65.888-62.806 0-122.954 26.329-165.547 72.348-7.616-2.821-15.75-4.293-24.108-4.293-.001 0 .001 0 0 0-18.539 0-35.977 7.24-49.098 20.385-.274.275-.532.565-.772.87l-15.678 19.868c-14.987 18.993-25.114 41.58-29.285 65.318-4.207 23.943-2.269 48.627 5.605 71.384 5.707 16.494 12.887 29.151 21.342 37.622l193.83 194.143c6.704 6.717 16.109 12.686 27.956 17.74 17.668 7.539 36.431 11.233 55.167 11.232 31.195-.001 62.309-10.246 88.105-30.047l22.298-17.116c.348-.268.679-.558.989-.868 17.59-17.623 23.745-42.431 18.464-65.082 48.367-42.732 76.063-104.032 76.063-168.531zm-108.241 219.036-21.75 16.696c-35.571 27.305-82.795 33.545-123.246 16.285-9.479-4.044-16.763-8.578-21.65-13.474l-193.831-194.144c-6.301-6.313-11.885-16.418-16.596-30.032-13.829-39.97-6.173-83.997 20.48-117.773l15.301-19.391c9.295-9.111 21.541-14.121 34.546-14.121 13.19 0 25.599 5.155 34.941 14.514l32.021 32.081c18.41 18.444 18.41 48.454-.002 66.9l-35.863 35.951c-3.895 3.905-3.894 10.226.003 14.128l126.446 126.631c1.876 1.878 4.421 2.934 7.076 2.934h.003c2.656 0 5.202-1.058 7.077-2.938l35.86-35.948c8.919-8.936 20.767-13.857 33.36-13.857s24.44 4.921 33.36 13.857l32.021 32.081c19.135 19.17 19.282 50.268.443 69.62zm-15.287-112.
42 452.99c-1.61-3.865-5.581-6.387-9.771-6.16-4.161.225-7.816 3.098-9.029 7.08-1.212 3.978.243 8.471 3.606 10.938 3.284 2.409 7.764 2.601 11.23.458 4.105-2.538 5.822-7.856 3.964-12.316z" data-v-64c352fa${_scopeId}></path></g></g></g></svg></div><h2 class="st-iconbox-title" data-v-64c352fa${_scopeId}>الحالات الطارئية</h2><div class="st-iconbox-text" data-v-64c352fa${_scopeId}>مختصين بمعالجة الحالات الطارئة والعاجلة .</div></div><div class="st-height-b0 st-height-lg-b30" data-v-64c352fa${_scopeId}></div></div></div></div></section><section class="st-about-wrap" id="about" data-v-64c352fa${_scopeId}><div class="st-shape-bg" data-v-64c352fa${_scopeId}><img${ssrRenderAttr("src", _ctx.asset_url("assets/img/shape/about-bg-shape.svg"))} alt="shape" data-v-64c352fa${_scopeId}></div><div class="st-height-b120 st-height-lg-b50" data-v-64c352fa${_scopeId}></div><div class="container" data-v-64c352fa${_scopeId}><div class="st-section-heading st-style1" data-v-64c352fa${_scopeId}><h2 class="st-section-heading-title" data-v-64c352fa${_scopeId}>${ssrInterpolate(_ctx.__("Home.Who We Are"))}</h2><div class="st-seperator" data-v-64c352fa${_scopeId}><div class="st-seperator-left wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.2s" data-v-64c352fa${_scopeId}></div><div class="st-seperator-center" data-v-64c352fa${_scopeId}><img src="assets/img/icons/4.png" alt="icon" data-v-64c352fa${_scopeId}></div><div class="st-seperator-right wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.2s" data-v-64c352fa${_scopeId}></div></div><div class="st-section-heading-subtitle" data-v-64c352fa${_scopeId}><span data-v-64c352fa${_scopeId}>${_ctx.__("Home.Text About Us")}</span></div></div><div class="st-height-b40 st-height-lg-b40" data-v-64c352fa${_scopeId}></div></div><div class="container" data-v-64c352fa${_scopeId}><div class="row" data-v-64c352fa${_scopeId}><div class="col-lg-7" data-v-64c352fa${_scopeId}><div class="st-vertical-middle" data-v-64c352fa${_scopeId}><div class="st-vertical-middle-in" data-v-64c352fa${_scopeId}><div class="st-text-block st-style1" data-v-64c352fa${_scopeId}><h2 class="st-text-block-title" data-v-64c352fa${_scopeId}>${ssrInterpolate(_ctx.__("Home.Title About us-text"))}</h2><div class="st-height-b20 st-height-lg-b20" data-v-64c352fa${_scopeId}></div><div class="st-text-block-text" data-v-64c352fa${_scopeId}>${_ctx.__("Home.Sub About us-text")}</div><div class="st-height-b25 st-height-lg-b25" data-v-64c352fa${_scopeId}></div><div class="st-text-block-avatar" data-v-64c352fa${_scopeId}><div class="st-avatar-img" data-v-64c352fa${_scopeId}><img src="assets/img/avatar1.png" alt="avatar" data-v-64c352fa${_scopeId}></div><div class="st-avatar-info" data-v-64c352fa${_scopeId}><h4 class="st-avatar-name" data-v-64c352fa${_scopeId}>د . حامد</h4><div class="st-avatar-designation" data-v-64c352fa${_scopeId}>خبير العلاج الطبي</div></div></div></div></div></div><div class="st-height-b0 st-height-lg-b30" data-v-64c352fa${_scopeId}></div></div><div class="col-lg-5 wow fadeInRight" data-wow-duration="0.8s" data-wow-delay="0.2s" data-v-64c352fa${_scopeId}><div class="st-shedule-wrap" data-v-64c352fa${_scopeId}><div class="st-shedule" data-v-64c352fa${_scopeId}><h2 class="st-shedule-title" data-v-64c352fa${_scopeId}>${ssrInterpolate(_ctx.__("Timetable.Title"))}</h2><ul class="st-shedule-list" data-v-64c352fa${_scopeId}><li data-v-64c352fa${_scopeId}><div class="st-shedule-left" data-v-64c352fa${_scopeId}>${ssrInterpolate(_ctx.__("Timetable.Saturday"))}</div><div class="st-shedule-right" data-v-64c352fa${_scopeId}>${ssrInterpolate(_ctx.__("Timetable.Saturday_1"))}</div></li><li data-v-64c352fa${_scopeId}><div class="st-shedule-left" data-v-64c352fa${_scopeId}>${ssrInterpolate(_ctx.__("Timetable.Sunday"))}</div><div class="st-shedule-right" data-v-64c352fa${_scopeId}>${ssrInterpolate(_ctx.__("Timetable.Sunday_1"))}</div></li><li data-v-64c352fa${_scopeId}><div class="st-shedule-left" data-v-64c352fa${_scopeId}>${ssrInterpolate(_ctx.__("Timetable.Monday"))}</div><div class="st-shedule-right" data-v-64c352fa${_scopeId}>${ssrInterpolate(_ctx.__("Timetable.Monday_1"))}</div></li><li data-v-64c352fa${_scopeId}><div class="st-shedule-left" data-v-64c352fa${_scopeId}>${ssrInterpolate(_ctx.__("Timetable.Tuesday"))}</div><div class="st-shedule-right" data-v-64c352fa${_scopeId}>${ssrInterpolate(_ctx.__("Timetable.Tuesday_1"))}</div></li><li data-v-64c352fa${_scopeId}><div class="st-shedule-left" data-v-64c352fa${_scopeId}>${ssrInterpolate(_ctx.__("Timetable.Wednesday"))}</div><div class="st-shedule-right" data-v-64c352fa${_scopeId}>${ssrInterpolate(_ctx.__("Timetable.Wednesday_1"))}</div></li><li data-v-64c352fa${_scopeId}><div class="st-shedule-left" data-v-64c352fa${_scopeId}>${ssrInterpolate(_ctx.__("Timetable.Thursday"))}</div><div class="st-shedule-right" data-v-64c352fa${_scopeId}>${ssrInterpolate(_ctx.__("Timetable.Thursday_1"))}</div></li><li data-v-64c352fa${_scopeId}><div class="st-shedule-left" data-v-64c352fa${_scopeId}>${ssrInterpolate(_ctx.__("Timetable.Friday"))}</div><div class="st-shedule-right" data-v-64c352fa${_scopeId}>${ssrInterpolate(_ctx.__("Timetable.Friday_1"))}</div></li></ul><div class="st-height-b25 st-height-lg-b25" data-v-64c352fa${_scopeId}></div><div class="st-call st-style1" data-v-64c352fa${_scopeId}><div class="st-call-icon" data-v-64c352fa${_scopeId}><svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" xml:space="preserve" data-v-64c352fa${_scopeId}><g data-v-64c352fa${_scopeId}><path d="M492.557,400.56L392.234,300.238c-11.976-11.975-31.458-11.975-43.435,0l-26.088,26.088
                                                      ...
                                                      C470.84,422.278,444.761,448.377,444.752,448.368z" data-v-64c352fa${_scopeId}></path></g><g data-v-64c352fa${_scopeId}><path d="M388.818,123.184c-29.209-29.209-68.042-45.294-109.344-45.293c-8.481,0-15.356,6.875-15.356,15.356
                                                      c0,8.481,6.876,15.356,15.356,15.356c33.1-0.002,64.219,12.89,87.628,36.297c23.406,23.406,36.295,54.525,36.294,87.624
                                                      c0,8.481,6.875,15.358,15.356,15.358c8.48,0,15.356-6.875,15.356-15.354C434.109,191.224,418.023,152.393,388.818,123.184z" data-v-64c352fa${_scopeId}></path></g><g data-v-64c352fa${_scopeId}><path d="M443.895,68.107C399.972,24.186,341.578-0.002,279.468,0c-8.481,0-15.356,6.876-15.356,15.356
                                                      c0,8.481,6.876,15.356,15.356,15.356c53.907-0.002,104.588,20.992,142.709,59.111c38.118,38.118,59.111,88.799,59.11,142.706
                                                      c0,8.481,6.875,15.356,15.356,15.356c8.48,0,15.356-6.875,15.356-15.354C512.001,170.419,487.813,112.027,443.895,68.107z" data-v-64c352fa${_scopeId}></path></g><g data-v-64c352fa${_scopeId}><path d="M333.737,178.26c-14.706-14.706-33.465-22.477-54.256-22.477c0,0-0.005,0-0.006,0
                                                      c-8.481,0.002-15.356,6.876-15.354,15.358c0.002,8.481,6.878,15.356,15.358,15.354c0.002,0,0.003,0,0.005,0
                                                      c12.644,0,23.593,4.536,32.539,13.481c8.819,8.82,13.481,20.075,13.479,32.544c-0.002,8.481,6.875,15.356,15.354,15.358h0.002
                                                      c8.481,0,15.354-6.875,15.356-15.354C356.215,211.732,348.444,192.968,333.737,178.26z" data-v-64c352fa${_scopeId}></path></g></svg></div><div class="st-call-text" data-v-64c352fa${_scopeId}><div class="st-call-title" data-v-64c352fa${_scopeId}>${ssrInterpolate(_ctx.__("Timetable.Call Now"))}</div><div class="st-call-number" data-v-64c352fa${_scopeId}>${ssrInterpolate(_ctx.__("Timetable.phone"))}</div></div></div></div></div></div></div></div></section><section class="st-before-after-section st-dynamic-bg st-bg" style="${ssrRenderStyle({ "background-image": "url('/assets/img/before-after-bg.jpg')" })}" data-v-64c352fa${_scopeId}><div class="st-height-b120 st-height-lg-b80" data-v-64c352fa${_scopeId}></div><div class="container" data-v-64c352fa${_scopeId}><div class="st-section-heading st-style1" data-v-64c352fa${_scopeId}><h2 class="st-section-heading-title" data-v-64c352fa${_scopeId}>${ssrInterpolate(_ctx.__("Home.Before and after procedures"))}</h2><div class="st-seperator" data-v-64c352fa${_scopeId}><div class="st-seperator-left wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.2s" data-v-64c352fa${_scopeId}></div><div class="st-seperator-center" data-v-64c352fa${_scopeId}><img src="/assets/img/icons/4.png" alt="icon" data-v-64c352fa${_scopeId}></div><div class="st-seperator-right wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.2s" data-v-64c352fa${_scopeId}></div></div><div class="st-section-heading-subtitle" data-v-64c352fa${_scopeId}>${ssrInterpolate(_ctx.__("Home.Before and after procedures_sub"))}</div></div><div class="st-height-b40 st-height-lg-b40" data-v-64c352fa${_scopeId}></div></div><div class="st-before-after-wrap" data-v-64c352fa${_scopeId}><div class="container" data-v-64c352fa${_scopeId}><div class="st-before-after-in" data-v-64c352fa${_scopeId}><div class="st-before-after" data-v-64c352fa${_scopeId}><div class="st-after st-single-slide st-dynamic-bg" style="${ssrRenderStyle({ "background-image": "url('/assets/img/after.jpg')" })}" data-v-64c352fa${_scopeId}></div><div class="st-before st-single-slide st-dynamic-bg" style="${ssrRenderStyle({ "background-image": "url('/assets/img/before.jpg')" })}" data-v-64c352fa${_scopeId}></div><div class="st-handle-before-after" data-v-64c352fa${_scopeId}><span data-v-64c352fa${_scopeId}></span></div></div></div></div></div></section><section data-v-64c352fa${_scopeId}><div class="st-height-b120 st-height-lg-b80" data-v-64c352fa${_scopeId}></div><div class="container" data-v-64c352fa${_scopeId}><div class="st-section-heading st-style1" data-v-64c352fa${_scopeId}><h2 class="st-section-heading-title" data-v-64c352fa${_scopeId}>${ssrInterpolate(_ctx.__("Home.What peoble say"))}</h2><div class="st-seperator" data-v-64c352fa${_scopeId}><div class="st-seperator-left wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.2s" data-v-64c352fa${_scopeId}></div><div class="st-seperator-center" data-v-64c352fa${_scopeId}><img src="assets/img/icons/4.png" alt="icon" data-v-64c352fa${_scopeId}></div><div class="st-seperator-right wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.2s" data-v-64c352fa${_scopeId}></div></div><div class="st-section-heading-subtitle" data-v-64c352fa${_scopeId}>${ssrInterpolate(_ctx.__("Home.What peoble say Sub"))}</div></div><div class="st-height-b40 st-height-lg-b40" data-v-64c352fa${_scopeId}></div></div><div class="container" data-v-64c352fa${_scopeId}>`);
        _push2(ssrRenderComponent(_component_slider_comments, { opinions: $props.opinions }, null, _parent2, _scopeId));
        _push2(`</div><div class="st-height-b120 st-height-lg-b80" data-v-64c352fa${_scopeId}></div></section><section class="st-gray-bg st-shape-wrap" data-v-64c352fa${_scopeId}><div class="st-shape4" data-v-64c352fa${_scopeId}><img src="/assets/img/shape/section_shape.png" alt="shape1" data-v-64c352fa${_scopeId}></div><div class="st-height-b120 st-height-lg-b80" data-v-64c352fa${_scopeId}></div><div class="container" data-v-64c352fa${_scopeId}><div class="row" data-v-64c352fa${_scopeId}><div class="col-xl-6" data-v-64c352fa${_scopeId}><div class="row" data-v-64c352fa${_scopeId}><div class="col-lg-6" data-v-64c352fa${_scopeId}><div class="st-funfact st-style1" data-v-64c352fa${_scopeId}><div class="st-funfact-icon st-purple-box" data-v-64c352fa${_scopeId}><svg enable-background="new 0 0 512 512" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" data-v-64c352fa${_scopeId}><g data-v-64c352fa${_scopeId}><path d="m316 76c0-33.084-26.916-60-60-60s-60 26.916-60 60 26.916 60 60 60 60-26.916 60-60zm-60 40c-22.056 0-40-17.944-40-40s17.944-40 40-40 40 17.944 40 40-17.944 40-40 40z" data-v-64c352fa${_scopeId}></path><path d="m346 266v-40c0-49.626-40.374-90-90-90s-90 40.374-90 90v40c0 5.523 4.478 10 10 10h160c5.522 0 10-4.477 10-10zm-20-10h-140v-30c0-38.598 31.402-70 70-70s70 31.402 70 70z" data-v-64c352fa${_scopeId}></path><path d="m71.858 408.114 48.142 24.067v53.819c0 5.523 4.478 10 10 10h106c5.522 0 10-4.477 10-10v-127.22c0-31.783-23.452-59.203-53.391-62.423-.795-.15-38.649-2.971-56.948-21.258l-27.38-27.379c-7.556-7.558-17.6-11.72-28.281-11.72v-80c0-22.056-17.944-40-40-40s-40 17.944-40 40v135.84c0 49.212 27.798 94.239 71.858 116.274zm-51.858-252.114c0-11.028 8.972-20 20-20s20 8.972 20 20v85.361c-12.196 7.052-20 20.2-20 34.639 0 10.68 4.162 20.723 11.719 28.28l51.21 51.22c3.903 3.905 10.236 3.907 14.142.001 3.905-3.905 3.906-10.236.001-14.142l-51.21-51.221c-3.78-3.779-5.862-8.8-5.862-14.138 0-8.464 5.357-16.044 13.332-18.861.003-.001.006-.003.009-.004h.001c6.88-2.439 15.066-1.005 20.797 4.726l27.383 27.383c18.65 18.637 45.831 23.879 68.836 26.986.037.004.075.009.113.013 19.923 2.142 35.529 20.827 35.529 42.537v117.22h-86v-50c0-3.788-2.141-7.251-5.528-8.944l-53.669-26.83c-37.504-18.757-60.803-56.456-60.803-98.386z" data-v-64c352fa${_scopeId}></path><circle cx="459" cy="384" r="10" data-v-64c352fa${_scopeId}></circle><path d="m472 116c-22.056 0-40 17.944-40 40v80c-10.681 0-20.725 4.162-28.281 11.719l-27.377 27.377c-15.96 15.949-41.848 18.608-56.951 21.262-29.939 3.22-53.391 30.639-53.391 62.422v127.22c0 5.523 4.478 10 10 10h106c5.522 0 10-4.477 10-10v-53.819l32.73-16.362c4.939-2.47 6.942-8.476 4.473-13.417-2.469-4.939-8.474-6.942-13.416-4.473l-38.259 19.125c-3.387 1.695-5.528 5.158-5.528 8.946v50h-86v-117.22c0-21.71 15.606-40.395 35.529-42.538.038-.004.076-.008.113-.013 23.361-3.155 50.206-8.368 68.839-26.988l27.38-27.38c5.724-5.724 13.913-7.166 20.797-4.726h.001c.003.001.006.003.009.004 7.975 2.817 13.332 10.397 13.332 18.861 0 5.338-2.082 10.359-5.861 14.14l-51.21 51.22c-3.905 3.906-3.904 10.237.001 14.142 3.904 3.904 10.237 3.905 14.142-.001l51.21-51.22c7.556-7.558 11.718-17.601 11.718-28.281 0-14.439-7.804-27.587-20-34.639v-85.361c0-11.028 8.972-20 20-20s20 8.972 20 20v135.84c0 18.296-4.617 36.46-13.353 52.528-2.639 4.852-.844 10.924 4.009 13.562 4.851 2.637 10.924.843 13.562-4.009 10.325-18.99 15.782-40.458 15.782-62.081v-135.84c0-22.056-17.944-40-40-40z" data-v-64c352fa${_scopeId}></path></g></svg></div><h2 class="st-funfact-number st-counter" data-v-64c352fa${_scopeId}>${ssrInterpolate(_ctx.__("Home.Years of experience Number"))}</h2><div class="st-funfact-title" data-v-64c352fa${_scopeId}>${ssrInterpolate(_ctx.__("Home.Years of experience"))}</div></div><div class="st-height-b30 st-height-lg-b30" data-v-64c352fa${_scopeId}></div></div><div class="col-lg-6" data-v-64c352fa${_scopeId}><div class="st-funfact st-style1" data-v-64c352fa${_scopeId}><div class="st-funfact-icon st-green-box" data-v-64c352fa${_scopeId}><svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" xml:space="preserve" data-v-64c352fa${_scopeId}><g data-v-64c352fa${_scopeId}><path d="M107.972,291.258c-1.861-1.861-4.432-2.932-7.073-2.932c-2.631,0-5.213,1.071-7.073,2.932
                        c-1.861,1.86-2.931,4.441-2.931,7.072c0,2.642,1.071,5.213,2.931,7.083c1.861,1.861,4.442,2.921,7.073,2.921
                        s5.213-1.06,7.073-2.921c1.861-1.871,2.931-4.441,2.931-7.083C110.903,295.699,109.833,293.118,107.972,291.258z" data-v-64c352fa${_scopeId}></path></g><g data-v-64c352fa${_scopeId}><path d="M202.317,291.258c-1.86-1.861-4.441-2.932-7.073-2.932c-2.631,0-5.213,1.071-7.073,2.932
                        c-1.861,1.86-2.931,4.441-2.931,7.072c0,2.642,1.07,5.213,2.931,7.083c1.861,1.861,4.442,2.921,7.073,2.921
                        c6.758,3.902,14.26,5.896,21.861,5.896c3.811,0,7.646-0.5,11.425-1.514C408.75,390.222,422.663,366.121,416.404,342.76z" data-v-64c352fa${_scopeId}></path></g></svg></div><h2 class="st-funfact-number st-counter" data-v-64c352fa${_scopeId}>${ssrInterpolate(_ctx.__("Home.Happy Patients Number"))}</h2><div class="st-funfact-title" data-v-64c352fa${_scopeId}>${ssrInterpolate(_ctx.__("Home.Happy Patients"))}</div></div><div class="st-height-b30 st-height-lg-b30" data-v-64c352fa${_scopeId}></div></div><div class="col-lg-6" data-v-64c352fa${_scopeId}><div class="st-funfact st-style1" data-v-64c352fa${_scopeId}><div class="st-funfact-icon st-orange-box" data-v-64c352fa${_scopeId}><svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" xml:space="preserve" data-v-64c352fa${_scopeId}><g data-v-64c352fa${_scopeId}><path d="M482.726,485.783l-22.65-132.603c-2.441-14.287-12.576-25.764-26.453-29.95l-61.092-18.433
                      c-1.265-14.934-7.388-29.023-17.578-40.175c-8.151-8.92-18.403-15.415-29.704-18.999c1.934-2.146,3.727-4.285,5.372-6.377
                      c14.528-18.477,22.306-38.833,24.286-52.724h4.713c12.258,0,22.231-9.972,22.231-22.231v-11.396
                      c0-8.181-4.602-15.594-11.523-19.441V106.05c0-4.141-3.357-7.498-7.498-7.498s-7.497,3.356-7.497,7.498v30.764
                      c-2.92,0.507-6.404,1.383-9.968,2.884c-0.365,0.133-0.72,0.287-1.056,0.472c-0.805,0.367-1.611,0.754-2.414,1.19V80.938
                      ...
                      C90.4,36.8,127.2,20.4,168,20.4s77.6,16.4,104.4,43.2c26.8,26.8,43.2,63.6,43.2,104.4S298.8,245.6,272.4,272.4z" data-v-64c352fa${_scopeId}></path></g><g data-v-64c352fa${_scopeId}><path d="M261.2,156c-0.8-0.8-2-2.4-3.2-4c-0.4-0.4-0.4-0.4-0.8-0.8c-1.2-1.2-2.4-2-4-2.8l-59.2-34c0,0-0.4,0-0.4-0.4L134,79.6
                      ...
                      C244,167.6,244,168,244,168.4z" data-v-64c352fa${_scopeId}></path></g></svg><span class="st-video-animaiton" data-v-64c352fa${_scopeId}><span data-v-64c352fa${_scopeId}></span></span></a></div></div></div></div></section><div class="st-google-map" data-v-64c352fa${_scopeId}><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d96652.27317354927!2d-74.33557928194516!3d40.79756494697628!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c3a82f1352d0dd%3A0x81d4f72c4435aab5!2sTroy+Meadows+Wetlands!5e0!3m2!1sen!2sbd!4v1563075599994!5m2!1sen!2sbd" allowfullscreen data-v-64c352fa${_scopeId}></iframe></div></div><div class="st-video-popup" data-v-64c352fa${_scopeId}><div class="st-video-popup-overlay" data-v-64c352fa${_scopeId}></div><div class="st-video-popup-content" data-v-64c352fa${_scopeId}><div class="st-video-popup-layer" data-v-64c352fa${_scopeId}></div><div class="st-video-popup-container" data-v-64c352fa${_scopeId}><div class="st-video-popup-align" data-v-64c352fa${_scopeId}><div class="embed-responsive embed-responsive-16by9" data-v-64c352fa${_scopeId}><iframe class="embed-responsive-item" src="about:blank" data-v-64c352fa${_scopeId}></iframe></div></div><div class="st-video-popup-close" data-v-64c352fa${_scopeId}></div></div></div></div>`);
      } else {
        return [
...
const Welcome = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-64c352fa"]]);
...
createServer(
  (page) => createInertiaApp({
    ...
    resolve: (name) => {
      const pages = /* @__PURE__ */ Object.assign({ "./Pages/About.vue": __vite_glob_0_0, "./Pages/Welcome.vue": __vite_glob_0_1 });
