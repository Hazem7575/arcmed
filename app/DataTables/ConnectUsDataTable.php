...
class ConnectUsDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', '
                @can("connect.show")
                <a href="javascript:void(0)" data-container=".view_modal" data-href="{{route("admin.connect.show" , $id)}}"  class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1 btn-modal">
                ...
                @endcan
                @can("connect.destroy")
                <a data-table="#sectionService-table" href="javascript:void(0)" data-href="{{route("admin.connect.destroy" , $id)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm delete-option">
                    <span class="svg-icon svg-icon-3">
     ...
     */
    public function query(ConnectUs $model): QueryBuilder
    {
