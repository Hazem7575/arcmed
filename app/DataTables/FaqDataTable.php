...
class FaqDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', '
                <a href="javascript:void(0)" data-container=".view_modal" data-href="{{route("admin.faq.edit" , $id)}}"  class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1 btn-modal">
                ...
                <a data-table="#faq-table" href="javascript:void(0)" data-href="{{route("admin.faq.destroy" , $id)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm delete-option">
                    <span class="svg-icon svg-icon-3">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make(prefix_lang('name' , 'name' , true))->title('السوال'),
