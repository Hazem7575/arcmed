...
@section('content')
    <div class="st-content">
                    ...
                    @foreach($sliders as $slide)
                        <div class="slick-slide-in">
                            <div class="st-hero st-style1 st-size1">
                                <img class="st-hero-bg st-dynamic-bg st-bg" src="{{asset($slide->image)}}">
                                <div class="container">
                                    <div class="st-hero-text">
                                        @if(!empty($slide->text['title']))
                                            <h1 class="st-hero-title">
                                                {{$slide->text['title']}}
                                            </h1>
                                        @endif
                                        @if(!empty($slide->text['content']))
                                            <div class="st-hero-subtitle">
                                                {{$slide->text['content']}}
                                            </div>
                                        @endif
                                        @if(!empty($slide->text['link']))
                ...
                <div class="row">
                    ...
                    <g><path d="M482.726,485.783l-22.65-132.603c-2.441-14.287-12.576-25.764-26.453-29.95l-61.092-18.433
                      ...
                      s-23.8-10.676-23.8-23.8c0-13.124,10.677-23.8,23.8-23.8S389.001,385.251,389.001,398.375z" />
                            ...
                            <h2 class="st-iconbox-title">تواصل مع مختصين</h2>
                            <div class="st-iconbox-text">تواصل مع جميع الاطباء المختصين في العلاج الطبيعي.</div>
                        </div>
                    ...
                    <div class="col-lg-4">
                        <div class="st-iconbox st-style1">
                            ...
                            <h2 class="st-iconbox-title">الخدمة 24 ساعه</h2>
                            <div class="st-iconbox-text">متاحين 24 ساعه في اوقات العمل.</div>
                        </div>
                        <div class="st-height-b0 st-height-lg-b30"></div>
                    </div><!-- .col -->
                    <div class="col-lg-4">
                        <div class="st-iconbox st-style1">
                            ...
                            <h2 class="st-iconbox-title">الحالات الطارئية</h2>
                            <div class="st-iconbox-text">مختصين بمعالجة الحالات الطارئة والعاجلة .</div>
                        </div>
                        <div class="st-height-b0 st-height-lg-b30"></div>
                    </div><!-- .col -->
                </div>
        ...
        <section class="st-about-wrap" id="about">
            ...
            <div class="container">
                <div class="st-section-heading st-style1">
                    <h2 class="st-section-heading-title">{{__('Home.Who We Are')}}</h2>
                        ...
                        <div class="st-vertical-middle">
                            <div class="st-vertical-middle-in">
                                <div class="st-text-block st-style1">
                                    <h2 class="st-text-block-title">{{__('Home.Title About us-text')}}</h2>
                                    <div class="st-height-b20 st-height-lg-b20"></div>
                                    <div class="st-text-block-text">{!! __('Home.Sub About us-text') !!}</div>
                                    <div class="st-height-b25 st-height-lg-b25"></div>
                                    <div class="st-text-block-avatar">
                                        <div class="st-avatar-img"><img src="{{asset('assets/img/avatar1.png')}}" alt="avatar"></div>
                                        <div class="st-avatar-info">
                                            <h4 class="st-avatar-name">د . حامد</h4>
                                            <div class="st-avatar-designation">خبير العلاج الطبي</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-5 wow fadeInRight" data-wow-duration="0.8s" data-wow-delay="0.2s">
                        <div class="st-shedule-wrap">
                            <div class="st-shedule">
                                <h2 class="st-shedule-title">{{__('Timetable.Title')}}</h2>
                                <ul class="st-shedule-list">
                                    <li>
                                        <div class="st-shedule-left">{{__('Timetable.Saturday')}}</div>
                                        <div class="st-shedule-right">{{__('Timetable.Saturday_1')}}</div>
                                    </li>
                                    <li>
                                        <div class="st-shedule-left">{{__('Timetable.Sunday')}}</div>
                                        <div class="st-shedule-right">{{__('Timetable.Sunday_1')}}</div>
                                    </li>
                                    <li>
                                        <div class="st-shedule-left">{{__('Timetable.Monday')}}</div>
                                        <div class="st-shedule-right">{{__('Timetable.Monday_1')}}</div>
                                    </li>
                                    <li>
                                        <div class="st-shedule-left">{{__('Timetable.Tuesday')}}</div>
                                        <div class="st-shedule-right">{{__('Timetable.Tuesday_1')}}</div>
                                    </li>
                                    <li>
                                        <div class="st-shedule-left">{{__('Timetable.Wednesday')}}</div>
                                        <div class="st-shedule-right">{{__('Timetable.Wednesday_1')}} </div>
                                    </li>
                                    <li>
                                        <div class="st-shedule-left">{{__('Timetable.Thursday')}}</div>
                                        <div class="st-shedule-right">{{__('Timetable.Thursday_1')}}</div>
                                    </li>
                                    <li>
                                        <div class="st-shedule-left">{{__('Timetable.Friday')}}</div>
                                        <div class="st-shedule-right">{{__('Timetable.Friday_1')}}</div>
                                    </li>
                                ...
                                <div class="st-call st-style1">
                                    ...
                                    <div class="st-call-text">
                                        <div class="st-call-title">{{__('Timetable.Call Now')}}</div>
                                        <div class="st-call-number">{{__('Timetable.phone')}}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <section class="st-before-after-section st-dynamic-bg st-bg" data-src="{{asset('assets/img/before-after-bg.jpg')}}">
            ...
            <div class="container">
                <div class="st-section-heading st-style1">
                    <h2 class="st-section-heading-title">{{__('Home.Before and after procedures')}}</h2>
                    <div class="st-seperator">
                        <div class="st-seperator-left wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.2s"></div>
                        <div class="st-seperator-center"><img src="{{asset('assets/img/icons/4.png')}}" alt="icon"></div>
                        <div class="st-seperator-right wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.2s"></div>
                    </div>
                    <div class="st-section-heading-subtitle">{{__('Home.Before and after procedures_sub')}}</div>
                </div>
                <div class="st-height-b40 st-height-lg-b40"></div>
            </div>
                ...
                <div class="container">
                    <div class="st-before-after-in">
                        <div class="st-before-after">
                            <div class="st-after st-single-slide st-dynamic-bg" data-src="{{asset('assets/img/after.jpg')}}"></div>
                            <div class="st-before st-single-slide st-dynamic-bg" data-src="{{asset('assets/img/before.jpg')}}"></div>
        ...
        <section>
            ...
            <div class="container">
                <div class="st-section-heading st-style1">
                    <h2 class="st-section-heading-title">{{__('Home.What peoble say')}}</h2>
                    <div class="st-seperator">
                        <div class="st-seperator-left wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.2s"></div>
                        <div class="st-seperator-center"><img src="{{asset('assets/img/icons/4.png')}}" alt="icon"></div>
                        <div class="st-seperator-right wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.2s"></div>
                                ...
                                <div class="slick-slide-in ">
                                    <div class="st-testimonial st-style1 wow fadeInLeft" data-wow-duration="0.8s" data-wow-delay="0.2s">
                                        <div class="st-testimonial-info">
                                            <div class="st-testimonial-img"><img style="border-radius: 50%" src="{{asset($opinion->image)}}"></div>
                ...
                <div class="row">
                    <div class="col-xl-6">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="st-funfact st-style1">
                                    ...
                                    <h2 class="st-funfact-number st-counter">{{__('Home.Years of experience Number')}}</h2>
                                    <div class="st-funfact-title">{{__('Home.Years of experience')}}</div>
                                </div>
                      ...
                      <g>
                        ...
                        c6.758,3.902,14.26,5.896,21.861,5.896c3.811,0,7.646-0.5,11.425-1.514C408.75,390.222,422.663,366.121,416.404,342.76z" />
                                    ...
                                    <h2 class="st-funfact-number st-counter">{{__('Home.Happy Patients Number')}}</h2>
                                    <div class="st-funfact-title">{{__('Home.Happy Patients')}}</div>
                                </div>
                                <div class="st-height-b30 st-height-lg-b30"></div>
                            </div><!-- .col -->
                            <div class="col-lg-6">
                    ...
                    <g>
                      ...
                      s-23.8-10.676-23.8-23.8c0-13.124,10.677-23.8,23.8-23.8S389.001,385.251,389.001,398.375z"/>
                                    ...
                                    <h2 class="st-funfact-number st-counter">{{__('Home.Qualified Doctors Number')}}</h2>
                                    <div class="st-funfact-title">{{__('Home.Qualified Doctors')}}</div>
                                </div>
                                <div class="st-height-b30 st-height-lg-b30"></div>
                            </div><!-- .col -->
                            <div class="col-lg-6">
                                <div class="st-funfact st-style1">
                                    ...
                                    <h2 class="st-funfact-number st-counter">{{__('Home.Hospital Rooms Number')}}</h2>
                                    <div class="st-funfact-title">{{__('Home.Hospital Rooms')}}</div>
                                </div>
                                <div class="st-height-b30 st-height-lg-b30"></div>
                            </div><!-- .col -->
                        </div>
                    ...
                    <div class="col-xl-6 wow fadeInRight" data-wow-duration="0.8s" data-wow-delay="0.2s">
                        <div class="st-video-block st-style1 st-zoom">
                            <div class="st-video-block-img st-zoom-in st-dynamic-bg" data-src="{{asset('assets/img/video-block-img.jpg')}}"></div>
