<div class="modal-dialog modal-dialog-centered mw-650px" data-select2-id="select2-data-350-7fj5">
    ...
    <div class="modal-content">
        <!--begin::Form-->
        {!! Form::open(['url' => route('admin.user.store'), 'method' => 'post', 'id' => 'action_form_ajax', 'data-modal' => '.view_modal' , 'data-table' => '#user-table' ]) !!}

        <div class="modal-header" id="kt_modal_new_address_header">
            <h2>اضافة مستخدم جديدة</h2>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                {!! Form::text('name', null, ['class' => 'form-control form-control-solid', 'required', 'placeholder' => 'اسم المستخدم']); !!}
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                {!! Form::label('email', ' البريد الاكتروني  :') !!}
                                {!! Form::email('email', null, ['class' => 'form-control form-control-solid', 'placeholder' => 'البريد الاكتروني']); !!}
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                {!! Form::label('phone', '  رقم الهاتف :*') !!}
                                {!! Form::text('phone', null, ['class' => 'form-control form-control-solid', 'required', 'placeholder' => 'رقم الجوال']); !!}
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                {{Form::select('job',$role ,null , ['class' => 'form-control form-control-solid select2' , 'style' => 'width:100%'  , 'placeholder' => 'اختر وظيفة العضو'])}}
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
