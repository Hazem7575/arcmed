<div class="modal-dialog modal-dialog-centered mw-650px" data-select2-id="select2-data-350-7fj5">
    <div class="modal-content">
        {!! Form::open(['url' => route('admin.lang.update' , $lang->id), 'method' => 'post', 'id' => 'action_form_ajax', 'data-modal' => '#lang_modal' , 'data-table' => '#table-lang' ]) !!}
        @method('PUT')
            ...
            <div class="scroll-y me-n7 pe-7" id="kt_modal_new_address_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_new_address_header" data-kt-scroll-wrappers="#kt_modal_new_address_scroll" data-kt-scroll-offset="300px" style="max-height: 357px;" data-select2-id="select2-data-kt_modal_new_address_scroll">
                <div class="row mb-5">
                    ...
                    <div class="col-md-6 fv-row fv-plugins-icon-container">
                        ...
                        {{Form::select('group', collect($groups)->unique() , $lang->group , ['class' => 'form-control form-control-solid tags'  , 'placeholder' => 'المجموعة' , 'required'])}}
                        <div class="fv-plugins-message-container invalid-feedback"></div></div>
                    <div class="col-md-6 fv-row fv-plugins-icon-container">
                        {!! Form::label('key' , 'الاسم') !!}
                        {{Form::text('key', $lang->key  , ['class' => 'form-control form-control-solid'  , 'placeholder' => 'أدخل اسم العبارة' , 'required'])}}
                        <div class="fv-plugins-message-container invalid-feedback"></div>
                    </div>
                    @foreach($group_lang as $key => $row)
                        <div class="col-md-12 fv-row fv-plugins-icon-container mt-1">
                            {!! Form::label('text['.$key.']' , ' العبارة ' . $row) !!}
                            {{Form::textarea('text['.$key.']', $lang->text[$key], ['class' => 'form-control form-control-solid'    , 'placeholder' => 'العبارة', 'cols' => 60 , 'rows' => 6 , 'required'])}}
                            <div class="fv-plugins-message-container invalid-feedback"></div>
                        </div>
                    @endforeach
