<div class="modal-dialog modal-dialog-centered {{$size ?? 'mw-650px'}}">
    ...
    <div class="modal-content">
        <!--begin::Form-->
        {!! Form::open(['url' => $url, 'method' => 'post', 'id' => 'action_form_ajax', 'data-modal' => '.view_modal' , 'data-table' => $table , 'files' => true]) !!}
        @isset($put)
            @method('PUT')
        @endisset
