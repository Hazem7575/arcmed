        ...
        <div class="st-content">
            ...
            <section class="st-about-wrap" id="about">
                <div class="st-shape-bg">
                    <img :src="asset_url('assets/img/shape/about-bg-shape.svg')" alt="shape">
                </div>
                ...
                <div class="container">
                    <div class="st-section-heading st-style1">
                        ...
                        <div class="st-section-heading-subtitle">
                            <span v-html="__('Home.Text About Us')"></span>
                        </div>
                    </div>
                            ...
                            <div class="st-vertical-middle">
                                <div class="st-vertical-middle-in">
                                    <div class="st-text-block st-style1">
                                        ...
                                        <div class="st-text-block-text" v-html="__('Home.Sub About us-text')"></div>
                    ...
                    <div class="container">
                        <div class="st-before-after-in">
                            <div class="st-before-after">
                                <div class="st-after st-single-slide st-dynamic-bg" style="background-image: url('/assets/img/after.jpg')"></div>
                                <div class="st-before st-single-slide st-dynamic-bg" style="background-image: url('/assets/img/before.jpg')"></div>
            ...
            <section>
                ...
                <div class="container">
                    <slider-comments :opinions="opinions" />
                </div>
                <div class="st-height-b120 st-height-lg-b80"></div>
            </section>
                      ...
                      s-23.8-10.676-23.8-23.8c0-13.124,10.677-23.8,23.8-23.8S389.001,385.251,389.001,398.375z"/>
                        ...
                        <div class="col-xl-6 wow fadeInRight" data-wow-duration="0.8s" data-wow-delay="0.2s">
                            <div class="st-video-block st-style1 st-zoom">
                                <div class="st-video-block-img st-zoom-in st-dynamic-bg" style="background-image: url('/assets/img/video-block-img.jpg')"></div>
...
import SliderComments from "@/Components/SliderComments.vue";
import $ from  'jquery'
export default {
    name: "Welcome",
